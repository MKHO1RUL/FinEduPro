    ...
    <section class="heroBWA mt-5">
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-4">
            <img class="rounded-circle" src="gambar/orang1.png" alt="Generic placeholder image" width="140" height="140">
            <h2>Muhammad Khoirul I.I</h2>
            <p>(082111233068)</p>
 ...
 <div class="container">
    <div class="row">
      ...
      <div class="ending col-md-2">
        <h5>Source</h5>
        <ul class="list-unstyled">
          <li><a href="https://www.freepik.com/icon/finance-book_3132258">Image</a></li>
