...
<body>
    <nav class="navbar py-2 navbar-expand-lg navbar-light">
        <div class="container">
            ...
            ><img src="gambar/merek.png" width="150" alt="logo"
            /></a>
            <button
        ...
        <div class="container">
            <div class="row">
                <div class="col align-self-center">
                    <h3 class="mb-4">Indeks Literasi Keuangan Anda : </h3>
                    <?php
                        if(isset($_SESSION)) {
                    ...
                    <h3 class="mb-4">Solusi untuk meningkatkan kondisi keuangan Anda adalah : </h3>
                ...
                <div class="col d-none d-sm-block">
                    <img width="600" src="gambar/ending.png" alt="hero" />
                </div>
            </div>
        </div>
    </section>
