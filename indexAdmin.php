...
<body >
    <div class="kiri">
        <section class="logo">
            <img src="gambar/merek.png" alt="logo" height="70px" />
        </section>
        <div class="sidebar-heading">
            <h5 class="font-weight-bold text-uppercase teks">Data User</h5>
        </div>
        <section class="isi">
        ...
        <div class="sidebar-heading">
            <h5 class="font-weight-bold text-uppercase teks">Gejala & Penyakit</h5> 
        </div>
        <section class="isi">
        ...
        <div class="sidebar-heading">
            <h5 class="font-weight-bold text-uppercase teks">Solusi</h5> 
        </div>
        <section class="isi">
    ...
    <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-primary font-weight-bold text-uppercase mb-1">Data Pasien</div>
